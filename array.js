...
const numbers3 = [2, 4, 6, 9, 12];
const firstMultipleOf3 = numbers3.find((num) => num % 3 === 0);
...
const personOver30 = people2.find((person) => person.age > 30);
...
// 배열의 모든 요소를 합산
const sum = numbers4.reduce((accumulator, current) => accumulator + current, 0);
